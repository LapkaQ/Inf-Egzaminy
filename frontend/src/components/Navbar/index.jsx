        ...
        <div className="flex items-center justify-end gap-3 min-w-0">
          {isAuthenticated ? (
            ...
            <>
              <Link
                to="/login"
                className="px-4 py-2 rounded-lg border border-line-hi text-subtle text-sm font-medium hover:text-white hover:border-white/20 hover:bg-white/[0.04] transition-all duration-200"
              >
                Zaloguj się
              </Link>
              <Link
                to="/register"
                className="px-4 py-2 rounded-lg bg-gradient-to-br from-accent to-accent-2 text-white text-sm font-semibold hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(124,58,237,0.45)] transition-all duration-200"
              >
                Zarejestruj →
              </Link>
            </>
